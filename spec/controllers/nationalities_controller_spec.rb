  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created nationality" do
        post :create, {:nationality => valid_attributes}, valid_session
        expect(response).to redirect_to(Nationality.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved nationality as @nationality" do
        post :create, {:nationality => invalid_attributes}, valid_session
        expect(assigns(:nationality)).to be_a_new(Nationality)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, {:id => nationality.to_param, :nationality => new_attributes}, valid_session
        nationality.reload
      ...
      it "redirects to the nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, {:id => nationality.to_param, :nationality => valid_attributes}, valid_session
        expect(response).to redirect_to(nationality)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the nationality as @nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, {:id => nationality.to_param, :nationality => invalid_attributes}, valid_session
        expect(assigns(:nationality)).to eq(nationality)
      end
